...
namespace FluffyUnderware.DevToolsEditor
{
    public static class DTHandles
    {
        ...
        public static Vector3 PositionHandle2D(int id, Vector3 position, Quaternion rotation, float size, int plane = 0)
        {
            ...
            updatedPosition += Handles.Slider2D(id, position, rectSize * (axis1 + axis2), Vector3.Cross(axis1, axis2), axis2, axis1, rectSize, Handles.RectangleHandleCap, new Vector2(snap.x, snap.y)) - position;
